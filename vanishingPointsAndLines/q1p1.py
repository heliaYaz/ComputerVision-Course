...
##
image = cv2.imread("vns.jpg")
print("v_x:",v_x.astype(int))
print("v_y:",v_y.astype(int))
print("v_z:",v_z.astype(int))

##

im11 = cv2.imread("vns.jpg")

v_lined = draw_line(v_x, v_y,im11)
cv2.imwrite('res01.jpg', v_lined)

result = draw_all_van_points(im11, v_x, v_y, v_z)
cv2.imwrite('res02.jpg', result)

##
# get line
vanishing_line = np.cross(v_x, v_y)

av = -vanishing_line[0]
bv = -vanishing_line[1]
cv = -vanishing_line[2]

norm = math.sqrt(av**2 + bv**2)

print(av/norm , bv/norm, cv/norm)
